  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setPosts(data.User_Posts || []); // Assign fetched data or an empty array
      } catch (error) {
        console.error("Error:", error);
      }
    };
    ...
    return (
      <>
        ...
        <li key={postId} className="case-card-posts">
          <button className="allpost-delete" onClick={() =>deletePost(postId)}>
            Delete
          </button>
          ...
          <div className="post-buttons">
            ...
            <button className="allpost-button" onClick={() => handleApplicableLaws(postId, laws)}>Applicable Laws</button>
  ...
  return (
    <div className="all-posts-container">
      <div className="user-posts">
        <h2 className="all-posts-heading">User Posts:</h2>
